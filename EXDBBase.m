...
- (BOOL)updateObject:(id)object value2Key:(NSDictionary *)dictionary {
    NSString *sql = [EXDBBaseString updateStringWithClass:object value2Key:dictionary];
...
- (NSArray *)getObjectWithObjectName:(NSString *)name value2KeyForAndCondition:(NSDictionary *)dictionary {
    ...
    NSString *sql = [EXDBBaseString getObjectStringWithObjectName:name value2KeyForAndCondition:dictionary];
...
- (BOOL)deleteObjectName:(NSString *)objectName value2Key:(NSDictionary *)dictionary {
    NSString *sql = [EXDBBaseString deleteObjectStringWithClassName:objectName value2Key:dictionary];
